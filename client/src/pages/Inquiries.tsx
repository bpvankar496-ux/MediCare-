...
export default function Inquiries() {
  ...
  if (loading) return <div><PageHeader title={"Ask Reception"} subtitle={"Send a question to the front desk"} icon={HeartHandshake} /><LoadingState /></div>
  if (error) return <div><PageHeader title={"Ask Reception"} subtitle={"Send a question to the front desk"} icon={HeartHandshake} /><ErrorState message={error} /></div>

  return (
    <div className="fade-in">
      <PageHeader title={"Ask Reception"} subtitle={"Send a question to the front desk"} icon={HeartHandshake} />
