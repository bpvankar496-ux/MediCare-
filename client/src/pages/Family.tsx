...
export default function Family() {
  ...
  if (loading) return <div><PageHeader title={"Family Members"} subtitle={"Manage your family's health from one account"} icon={Users} /><LoadingState /></div>
  if (error) return <div><PageHeader title={"Family Members"} subtitle={"Manage your family's health from one account"} icon={Users} /><ErrorState message={error} /></div>

  return (
    <div className="fade-in">
      <PageHeader title={"Family Members"} subtitle={"Manage your family's health from one account"} icon={Users} />
